...
bot = TeleBot(token='5751903885:AAGxgb_3q58NY-9dJpFByrHplZsBrIz3Jbk', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_photo(message.chat.id, "https://static.tildacdn.com/tild3165-6463-4563-a333-643137616537/cat-computer-veryfas.gif")
    bot.send_message(
        
        chat_id=message.chat.id, # id чата, в который необходимо направить сообщение
       
        text='Привет, дружище! Я умею проверять JSON и форматировать его в красивый текст\nВведи JSON в виде строки и не останавливайся:', # текст сообщения
    )
